export const ChooseProfessionTemplate = `
				...
				<div class="container-for-popup">
					...
					<section class="popup">
						<h2 class="popup__heading">Ми пропонуємо тобі професію
							<span class="popup__faculty">тестувальник</span>
						</h2>
						<p class="popup__text">Тестувальник - спеціаліст, який спостерігає й вивчає, як працює програма, і шукає в ній помилки.</p>
