import { Question10 } from './question10.module'
import { Question10Template } from './question10.template'
...
export const Question9 = {
	...
	init(marks, main) {
        ...
        this.target.innerHTML += Question10Template
        this.check = false
        this.result = null
        this.marks = marks
		...
		this.submit.addEventListener('click', event => {
            ...
            if (this.check) {
                ...
                setTimeout(() => {
                	Question10.init(this.marks, main)
                }, 800)
            }
        })
