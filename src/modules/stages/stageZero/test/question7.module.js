import { Question8 } from './question8.module'
import { Question8Template } from './question8.template'
...
export const Question7 = {
	...
	init(marks, main) {
        ...
        this.target.innerHTML += Question8Template
        this.check = false
        this.result = null
        this.marks = marks
		...
		this.submit.addEventListener('click', event => {
            ...
            if (this.check) {
                ...
                setTimeout(() => {
                	Question8.init(this.marks, main)
                }, 800)
            }
        })
