import { Question7 } from './question7.module'
import { Question7Template } from './question7.template'
...
export const Question6 = {
	...
	init(marks, main) {
        ...
        this.target.innerHTML += Question7Template
        this.check = false
        this.result = null
        this.marks = marks
		...
		this.submit.addEventListener('click', event => {
            ...
            if (this.check) {
                ...
                setTimeout(() => {
                	Question7.init(this.marks, main)
                }, 800)
            }
        })
