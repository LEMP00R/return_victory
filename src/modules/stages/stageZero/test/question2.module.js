import { Question3 } from './question3.module'
import { Question3Template } from './question3.template'
...
export const Question2 = {
	...
	init(marks, main) {
        ...
        this.target.innerHTML += Question3Template
        this.check = false
        this.result = null
        this.marks = marks
		...
		this.submit.addEventListener('click', event => {
            ...
            if (this.check) {
                ...
                setTimeout(() => {
                	Question3.init(this.marks, main)
                }, 800)
            }
        })
