import { Question5 } from './question5.module'
import { Question5Template } from './question5.template'
...
export const Question4 = {
	init(marks, main) {
        ...
        this.target.innerHTML += Question5Template
        this.check = false
        this.result = null
        this.marks = marks
		...
		this.submit.addEventListener('click', event => {
            ...
            if (this.check) {
                ...
                setTimeout(() => {
                    Question5.init(this.marks, main)
                }, 800)
            }
        })
