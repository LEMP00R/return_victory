import { Question9 } from './question9.module'
import { Question9Template } from './question9.template'
...
export const Question8 = {
	...
	init(marks, main) {
        ...
        this.target.innerHTML += Question9Template
        this.check = false
        this.result = null
        this.marks = marks
		...
		this.submit.addEventListener('click', event => {
            ...
            if (this.check) {
                ...
                setTimeout(() => {
                	Question9.init(this.marks, main)
                }, 800)
            }
        })
