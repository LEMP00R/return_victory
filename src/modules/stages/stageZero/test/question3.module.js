import { Question4 } from './question4.module'
import { Question4Template } from './question4.template'
...
export const Question3 = {
	init(marks, main) {
        ...
        this.target.innerHTML += Question4Template
        this.check = false
        this.result = null
        this.marks = marks
		...
		this.submit.addEventListener('click', event => {
            ...
            if (this.check) {
                ...
                setTimeout(() => {
                    Question4.init(this.marks, main)
                }, 800)
            }
        })
