export const RegistrationTemplate = `
  <div class="registration">
    <div class="registration__wrapper">
      ...
      <form id="registration__form" class="registration__form" action="backend/registrationFunc.php" method="post">
        ...
        <div class="registration__item registration__name">
          ...
          <input type="text" id="registration-name" class="registration__input" name="registration-name" required />
        </div>
        <div class="registration__item registration__birth">
          ...
          <div class="container-for-birth">
            <input type="text" id="birth_date" class="registration__input" name="birth_date" required />
            <input type="text" id="birth_month" class="registration__input" name="birth_month" required />
            <input type="text" id="birth_year" class="registration__input" name="birth_year" required />
          </div>
        </div>
        ...
        <div class="registration__item registration__email">
          ...
          <input type="email" id="registration-email" class="registration__input" name="registration-email" required />
        </div>
        <div class="registration__item registration__password">
          <label for="registration-password">пароль</label><br/>
          <input type="password" id="registration-password" class="registration__input" name="registration-password" required />
        </div>
