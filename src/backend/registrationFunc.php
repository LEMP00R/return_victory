...
if ($password == $passwordAgain && $name != "" && $surname != "" && $password != "" && $date != "" && $email != "") {
    $query = "INSERT INTO `Users`(`email`, `password`, `name`, `surname`, `sex`, `date`) VALUES ('$email','$password','$name','$surname','$sex','$date')";
